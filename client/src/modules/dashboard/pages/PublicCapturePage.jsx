...
import { usePublicCaptureForm } from '../hooks/usePublicCaptureForm.js';
import { CheckCircle2, Sparkles, AlertCircle } from 'lucide-react';

export const PublicCapturePage = () => {
  const { formData, submitted, loading, error, handleChange, handleSubmit, resetForm } = usePublicCaptureForm();
          ...
          <CardContent>
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Input label="Full Name" name="name" value={formData.name} onChange={handleChange} placeholder="Alex Mercer" required />
                <Input label="Work Email" name="email" type="email" value={formData.email} onChange={handleChange} placeholder="alex@acme.com" required />
                <Input label="Phone Number" name="phone" value={formData.phone} onChange={handleChange} placeholder="+1 (555) 000-1122" />
                <Input label="Company Name" name="company" value={formData.company} onChange={handleChange} placeholder="Acme Innovations" />
