...
export const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    mm.add('(prefers-reduced-motion: no-preference)', () => {
      ...
      // Floating cards continuous gentle parallax loop
      ...
      // Feature cards scroll trigger reveal
  ...
  ">
          ...
          {/* Framed Mockup with Parallax Floating Cards */}
  ...
  "
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: Clock,
                title: 'Automatic 24-Hour SLA Tracking',
                desc: 'Every new lead gets an automatic 24h countdown. Color-shifting badges warn your team before breaches occur.',
                color: 'text-amber-600 bg-amber-50 border-amber-200',
              },
              {
                icon: Shield,
                title: 'Role-Based Access (RBAC)',
                desc: 'Grant Admin full user management & deletion rights while restricting Members to pipeline execution and note adding.',
                color: 'text-emerald-700 bg-emerald-50 border-emerald-200',
              },
              {
                icon: FileText,
                title: 'Immutable Activity Audit Log',
                desc: 'Every status shift, rep reassignment, and note is permanently recorded for 100% team accountability.',
                color: 'text-teal-700 bg-teal-50 border-teal-200',
              },
              {
                icon: Sparkles,
                title: 'Public Lead Capture API',
                desc: 'Embed public inbound form endpoints anywhere with zero auth required. Leads route straight into your pipeline.',
                color: 'text-emerald-700 bg-emerald-50 border-emerald-200',
              },
              {
                icon: BarChart3,
                title: 'Real-Time Pipeline Analytics',
                desc: 'Monitor stage distribution, pipeline dollar value, conversion metrics, and rep performance live.',
                color: 'text-teal-700 bg-teal-50 border-teal-200',
              },
              {
                icon: Zap,
                title: 'Unified Toast System',
                desc: 'Instant micro-feedback and notifications for every lead update, role change, or reassignment.',
                color: 'text-amber-600 bg-amber-50 border-amber-200',
              },
            ].map((f, idx) => {
              const Icon = f.icon;
            ...
            {[
              {
                step: '01',
                title: 'Capture',
                subtitle: 'Inbound API & Forms',
                desc: 'Leads arrive automatically via public form endpoints or manual entry with instant SLA timestamps.',
                img: 'https://images.unsplash.com/photo-1553877522-43269d4ea984?auto=format&fit=crop&w=600&q=80',
              },
              {
                step: '02',
                title: 'Assign & Track',
                subtitle: 'Role & SLA Governance',
                desc: 'Smart routing assigns leads to reps with SLA timers counting down to guarantee fast response.',
                img: 'https://images.unsplash.com/photo-1534536281715-e28d76689b4d?auto=format&fit=crop&w=600&q=80',
              },
              {
                step: '03',
                title: 'Close & Audit',
                subtitle: 'Conversion & Logs',
                desc: 'Move deals through Kanban stages with immutable logs capturing every decision to won status.',
  ...
  ">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: "HEROES SLA countdown changed our response time overnight. We reduced our first contact delay from 14 hours down to under 35 minutes.",
                name: "Marcus Vance",
                role: "VP of Global Sales, Velocity Scale",
                img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=400&q=80",
              },
              {
                quote: "The role-based access and immutable audit trail solved our compliance headache completely. Every note and status change is logged cleanly.",
                name: "Elena Rostova",
                role: "Head of Revenue Operations, Cloud Hero",
                img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=80",
              },
              {
                quote: "Simple, fast, and data-forward. My sales reps love the Kanban board while I get total executive visibility over pipeline conversion rates.",
                name: "David Kim",
                role: "Chief Commercial Officer, NextGen SaaS",
